                                ...
                                <div class="card-body">
                                    ...
                                    <form action="./proses-login.php" method="post">
                                        ...
                                        if (isset($_GET['pesan'])) {
                                            ...
                                            <i class="fa-solid fa-triangle-exclamation"></i> <strong>Gagal Login!</strong> Username/Password salah.
                                            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                                            </div>';
                                            } elseif ($ket == 'keluar') {
                                                echo '<div class="alert alert-success alert-dismissible fade show" role="alert">
                                            <i class="fa-solid fa-circle-info"></i> <strong>Info!</strong> Anda telah keluar
                                            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                                            </div>';
                                            } else {
                                                echo '<div class="alert alert-info alert-dismissible fade show" role="alert">
                                            <i class="fa-solid fa-circle-info"></i> <strong>Info!</strong> Silahkan login terlebih dahulu
                                            <button type="button" class="btn-close" data-bs-dismiss="alert" aria-label="Close"></button>
                                            </div>';
                                            }
                                        }
                                        ...
                                        <div class="mb-3">
                                            <label class="small mb-1" for="inputEmailAddress"><i class="fa-regular fa-envelope"></i> Email</label>
                                            <input class="form-control" id="inputEmailAddress" type="email" name="email" placeholder="Masukan alamat email" />
                                        </div>
                                        <!-- Form Group (password)-->
                                        <div class="mb-3">
                                            <label class="small mb-1" for="inputPassword"><i class="fa-solid fa-key"></i> Password</label>
